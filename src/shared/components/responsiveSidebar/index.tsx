...
export function ResponsiveSidebar() {
  ...
  return (
    <>
      <button onClick={() => setIsOpen(true)} className="fixed top-5 left-6">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="w-full h-screen fixed bg-white border-r border-r-black/5 overflow-y-auto"
          >
            <div className="px-5 py-5 relative">
              <button onClick={() => setIsOpen(false)} className="fixed top-5 left-6">
                <X size={32} />
              </button>
            ...
            <div className="relative">
              ...
              <div className="px-5 py-4 pt-2 pb-[150px]">
                ...
                <ul className="px-5 py-4 pt-2">
                  ...
                  <li
                    onClick={() => navigate("/controle/tipo-de-contribuinte")}
                    className={`flex text-black/50 text-sm items-center gap-3 py-[10px] mb-1 last:mb-0 cursor-pointer hover:text-black transition-all rounded-md ${
                      pathname === "/controle/tipo-de-contribuinte" && "text-black"
                    } `}
                  >
                    <Car size={20} weight="bold" /> Tipo de contribuinte
                  </li>
                  <li
              ...
              <div className="w-full bg-white h-[150px] px-5 py-5 pb-0 bottom-0 border-t border-t-black/5">
                <li
                  onClick={signOut}
