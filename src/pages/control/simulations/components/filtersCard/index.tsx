...
import { CustomerNameInput } from "../../modals/customer/components/customerNameInput";
import { Button } from "../button";
import { inputClassName } from "../input";
import { CustomSelect } from "../customSelect";
import { useLoading } from "../../modals/customer/hooks/loading";
import { useUFs } from "../../modals/customer/hooks/ufs";
...
export function FilterCard() {
  ...
  const { isLoading: isFilterLoading, setIsLoading: setIsFilterLoading } = useLoading();
